...
主要负责Python相关语言的前后端全栈与数据分析，主要负责前端技术栈，使用vue3、tailwindCSS4和naiveUI，目前正学习godot引擎的游戏制作和单页多应用设计。专业领域为人工智能，智能控制与自适应控制等控制科学相关领域。
~~其实最近在试着做网页操作系统~~
你可以随时通过[夏花的主页](www.edison.ink)来和我保持联系！（不过我也不保证这个网页会是什么）
