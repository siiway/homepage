...
<div class="home-hero">
  <div class="home-logo">
    <img src="/favicon.svg" alt="SiiWay Logo" />
  </div>

  <h1 class="home-title">
    <span class="hero-word-siiway">SiiWay</span>
    <span class="hero-word-team">Team</span>
  </h1>

  <p class="home-subtitle">欢迎来到 SiiWay 团队的官方主页！</p>

  <div class="home-actions">
    <a class="home-btn home-btn-primary" href="https://github.com/siiway" target="_blank" rel="noopener">
    ...
    <a class="home-btn home-btn-secondary" href="/zh/members">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/></svg>
      <span>成员简介</span>
    </a>
    <a class="home-btn home-btn-secondary" href="/zh/about/contact">
