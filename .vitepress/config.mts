...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: {
      ["/"]: [
        ...
        },
        {
          text: "外链",
          items: [
            { text: "QQ 群", link: "https://siiway.top/t/qq" },
            { text: "QQ 频道", link: "https://siiway.top/t/pd" },
            { text: "微信公众号", link: "https://siiway.top/t/wx" },
            { text: "Discord", link: "https://siiway.top/t/dc" },
            { text: "GitHub", link: "https://siiway.top/t/gh" },
            { text: "Telegram 群组", link: "https://siiway.top/t/tg" },
            { text: "Telegram 频道", link: "https://siiway.top/t/tgc" },
          ],
        },
      ],
      ["/en_us/"]: [
        ...
        },
        {
          ...
          items: [
            { text: "Discord", link: "https://siiway.top/t/dc" },
            { text: "GitHub", link: "https://siiway.top/t/gh" },
            { text: "Telegram Group", link: "https://siiway.top/t/tg" },
            { text: "Telegram Channel", link: "https://siiway.top/t/tgc" },
          ],
        },
      ],
    },
    ...
    socialLinks: [
      { icon: "qq", ariaLabel: "QQ 群", link: "https://siiway.top/t/qq" },
      {
        icon: {
